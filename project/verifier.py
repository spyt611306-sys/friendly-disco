...
OFFICIAL_TYPES = {"G2B", "PUBLIC_STD", "PUBLIC_NOTICE", "SHIP"}
...
class ProjectVerifier:
    ...
    def __init__(self, client: Optional[httpx.AsyncClient] = None) -> None:
        ...
        self.client = client or httpx.AsyncClient(
            ...
            headers={"User-Agent": "ShipDeliveryIntelligence/3.1 (+project-verification)"},
    ...
    async def verify(self, project: Dict[str, Any], search_external: bool = True) -> Dict[str, Any]:
        ...
        if official_count and news_sources:
            ...
            reason = f"공식 조달/기관 데이터 {official_count}건에서 프로젝트가 확인되었습니다. 독립 뉴스 근거는 아직 확인되지 않았습니다."
